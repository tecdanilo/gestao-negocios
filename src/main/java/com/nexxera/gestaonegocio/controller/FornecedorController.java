    ...
    public ResponseEntity<ResultadoServico<List<Fornecedor>>> listAll(){
        ...
        try{
            ...
            if ( fornecedores.isEmpty() ){
                ...
                retorno = new ResultadoServico<>(ApplicationConstants.RESULTADO_SERVICO_OK, fornecedores, null);
    ...
    public ResponseEntity<ResultadoServico<Fornecedor>> findOne(@PathVariable(value ="id") Long id){
        ...
        try{
            ...
            if ( fornecedor == null ){
                ...
                retorno = new ResultadoServico<>(ApplicationConstants.RESULTADO_SERVICO_OK, fornecedor, null);
                return ResponseEntity.ok(retorno);
            }
        }catch (Exception e){
